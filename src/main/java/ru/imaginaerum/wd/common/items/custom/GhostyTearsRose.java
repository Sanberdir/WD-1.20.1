...
public class GhostyTearsRose extends ItemNameBlockItem {
    public GhostyTearsRose(Block pBlock, Properties pProperties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        if(Screen.hasShiftDown()) {
            ...
            components.add(Component.translatable("wd.rose_ghosty_tears").withStyle(ChatFormatting.DARK_PURPLE));
        } else {
